				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<div class="pull-right">
							<a href="heart-beats-register.jsp"
										...
										<td>
											<div class="dropdown">
												...
												<div
													...
													<c:url value="heartBeats" var="linkEditar">
															<c:param name="acao" value="abrir-form-edicao" />
															 <c:param name="codigo" value="${p.id_hist_batimento_cardiaco }" />
													 </c:url> 
													
													<a class="dropdown-item" href="${linkEditar }"><i class="dw dw-edit2"></i> Editar</a> 
