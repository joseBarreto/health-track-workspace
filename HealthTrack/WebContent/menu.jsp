			...
			<div class="dropdown">
				<a class="dropdown-toggle" href="#" role="button"
					data-toggle="dropdown"> <span class="user-icon"> <img
						src="src/images/male_avatar_.svg" alt="">
				</span> <span class="user-name"> ${user.getNm_nome() } </span>
				</a>
				<div
					class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
					<a class="dropdown-item" href="#"><i class="dw dw-user1"></i>
						Perfil</a> <a class="dropdown-item" href="#"><i
						class="dw dw-settings2"></i> Configurações</a> <a
						class="dropdown-item" href="#"><i class="dw dw-help"></i>
						Ajuda</a> <a class="dropdown-item" href="login"><i
...
<div class="left-side-bar">
	<div class="brand-logo">
		<a href="index.jsp"> <img src="src/images/deskapp-logo.svg"
			alt="" class="dark-logo"> <img
			src="src/images/deskapp-logo.svg" alt="" class="light-logo">
		</a>
	...
	<div class="menu-block customscroll">
		<div class="sidebar-menu">
			<ul id="accordion-menu">
				<li>
					<a href="index.jsp" class="dropdown-toggle no-arrow"> <span
							class="micon dw dw-house-1"></span><span class="mtext">Dashboard</span>
					</a>
				</li>
				<li class="dropdown">
					<a href="javascript:;"
						class="dropdown-toggle"> <span class="micon dw dw-heart"></span><span
							class="mtext">Batimentos</span>
					</a>
					<ul class="submenu">
						<li><a href="heartBeats">Listagem</a></li>
						<li><a href="heart-beats-register.jsp">Cadastro</a></li>
					</ul>
				</li>
			<li class="dropdown">
					<a href="javascript:;"
						class="dropdown-toggle"> <span class="micon dw dw-balance"></span><span
							class="mtext">Peso</span>
					</a>
					<ul class="submenu">
						<li><a href="weightControl">Listagem</a></li>
						<li><a href="weight-control-register.jsp">Cadastro</a></li>
					</ul>
				</li>
